        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active btn btn-info me-2" data-bs-toggle="modal" data-bs-target="#addSwitchModal">+ Tambah Server</a>
                    </li>
                </ul>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil!',
                        text: 'Success check by SNMP Uptime: 15 hari, 22 jam, 37 menit, 38 detik',
